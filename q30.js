...
var userName = ["Malik-e-Ashter", "Zarrar Haider", " Hafi Ali", "Sultan Teepo"];
userName.forEach(function (adm) {
    if (adm === "admin") {
        console.log(" Hello  ".concat(adm, ", would you like to see a status report?"));
    }
    else {
        console.log(" Hello ".concat(adm, ", thank you for logging in again"));
    }
});
/*!
